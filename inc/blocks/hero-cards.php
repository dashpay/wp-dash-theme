<?php
// Block: Hero Cards
// Renders side-by-side cards with image or video background, content on top
// Background options: image upload OR video URL (played via <video> tag)

$cards = get_sub_field('hero_cards');
if ( is_array($cards) ) : ?>
