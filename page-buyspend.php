            ...
            <div v-cloak>
                ...
                <div class="bg-light py-4 filter-bar" v-if="type=='buy'">
                    <div class="container-sm">
                        ...
                        <?php endif; ?>
                        <ul class="buy-tabs">
                            <li :class="{ active: tabFilter === 'exchange' }"
                                v-on:click="tabFilter = 'exchange'">Exchange</li>
                            <li :class="{ active: tabFilter === 'onramp' }"
                                v-on:click="tabFilter = 'onramp'">Onramp</li>
                            <li :class="{ active: tabFilter === 'dex' }"
                                v-on:click="tabFilter = 'dex'">DEX</li>
                            <li :class="{ active: tabFilter === 'swap' }"
                                v-on:click="tabFilter = 'swap'">Swap</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="bg-light py-4 filter-bar" v-if="type=='spend'">
                    <div class="container py-5 spend">
                        <ul class="buy-tabs">
                            <li :class="{ active: category_c === '' }"
                                v-on:click="category_c = ''">All</li>
                            <li v-for="cat in categories"
                                v-if="cat"
                                :key="cat"
                                :class="{ active: category_c === cat }"
                                v-on:click="category_c = cat">
                                {{ cat }}
                            </li>
                        </ul>
                    </div>
